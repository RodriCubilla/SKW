...
namespace TarodevController {
    public class PlayerAnimator : MonoBehaviour {
        ...
        // [SerializeField,Range(0,1)] private float _maxTilt = 0.3f;
        ...
        //     // Tilt with slopes
        //     var tiltAngle = new Vector2(Mathf.Clamp(_player.GroundNormal.x, -_maxTilt, _maxTilt), _player.GroundNormal.y);
        //     transform.up = Vector2.SmoothDamp(transform.up, _grounded ? tiltAngle : Vector2.up, ref _tiltVelocity, _tileChangeSpeed);
        // }
